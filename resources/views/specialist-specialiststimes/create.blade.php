...
@section('content')
    ...
    <form method="POST" action="{{ route('specialist-specialiststimes.store') }}" class="col-6">
        @csrf
        @method('POST')
        ...
        <div class="form-group my-2">
            ...
            <input type="hidden" id="specialist_id" name="specialist_id" value="{{ $specialist->id }}">
            <div class="row g-2">
                <div class="col">
                    <input type="text" class="form-control @error('specialist_id') is-invalid @enderror" id="specialist_name" name="specialist_name" placeholder="Buscar Especialista" value="{{ $specialist->user->name }}" readonly>
                </div>
            </div>
