...
@section('content')
    ...
    <form method="POST" action="{{ route('specialiststimes.update', $specialiststime)}}" class="col-6">
        ...
        <div class="form-group my-2">
            ...
            value={{old('start_date',$specialiststime->start_date ? \Carbon\Carbon::parse($specialiststime->start_date)->format('Y-m-d\TH:i:s') : '')}}>
            @error('start_date')
            <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        <div class="form-group my-2">
            ...
            value={{old('end_date',$specialiststime->end_date ? \Carbon\Carbon::parse($specialiststime->end_date)->format('Y-m-d\TH:i:s') : '')}}>
            @error('end_date')
            <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
