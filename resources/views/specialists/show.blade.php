                ...
                <div class="form-group mt-4">
                    ...
                    <div id="services-container" class="my-2">
                        @if($specialist->services)
                            @foreach(json_decode($specialist->services) as $index => $service)
                                <div class="row my-3">
                                    <div class="row">
                                        <h4>Servicio N°:{{$index}}</h4>
                                    </div>
                                    <div class="row">
                                        <div class="col-5">
                                            <label for="services[{{$index}}][id_service]">ID</label>
                                            <input type="text" class="form-control" name="services[{{$index}}][id_service]" value={{$service->id_service}} readonly>
                                        </div>
                                        <div class="col-5">
                                            <label for="services[{{$index}}][name_service]">Nombre</label>
                                            <input type="text" class="form-control" name="services[{{$index}}][name_service]" value={{$service->name_service}} readonly>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="form-group mt-4">
                    ...
                    <div id="educations-container" class="my-2">
                        ...
                        @if($specialist->educations)
                            @foreach(json_decode($specialist->educations) as $index => $education)
                            <div class="row my-3">
                                <div class="row">
                                    <h4>Educacion N°:{{$index}}</h4>
                                </div>
                                <div class="row">
                                    <div class="col-6">
                                        <label for="educations[{{$index}}][header]">Encabezado:</label>
                                        <input type="text" class="form-control" name="educations[{{$index}}][header]" value="{{ $education->header }}" placeholder="titulo" readonly>
                                    </div>
                                    <div class="col-6">
                                        <label for="educations[{{$index}}][subheader]">Sub-Encabezado:</label>
                                        <input type="text" class="form-control" name="educations[{{$index}}][subheader]" value="{{ $education->subheader }}" placeholder="institutcion" readonly>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6">
                                        <label for="educations[{{$index}}][from]">Fecha de Inicio:</label>
                                        <input type="date" class="form-control" name="educations[{{$index}}][from]"  value="{{ $education->from }}" readonly>
                                    </div>
                                    <div class="col-6">
                                        <label for="educations[{{$index}}][to]">Fecha de Fin:</label>
                                        <input type="date" class="form-control" name="educations[{{$index}}][to]" value="{{ $education->to }}" readonly>
                                    </div>
                                </div>
                                <div class="row mt-1">
                                    <div class="col-6">
                                        <label for="educations[{{$index}}][is_active]">Actualmente estudias aca?</label>
                                        <input type="checkbox" class="form-check-input" name="educations[{{$index}}][is_active]" {{ $education->is_active  ? 'checked' : ''}} readonly>
                                    </div>
                                </div>
                            </div>
                            @endforeach
                ...
                <div class="form-group mt-4">
                    ...
                    <div id="experiences-container" class="my-2">
                        @if($specialist->experiences)
                            @foreach(json_decode($specialist->experiences) as $index => $experience)
                                <div class="row my-3">
                                    <div class="row">
                                        <h4>Experiencia N°:{{$index}}</h4>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <label for="experiences[{{$index}}][header]">Encabezado:</label>
                                            <input type="text" class="form-control" name="experiences[{{$index}}][header]" value="{{$experience->header}}}" placeholder="puesto" readonly>
                                        </div>
                                        <div class="col-6">
                                            <label for="experiences[{{$index}}][subheader]">Sub-Encabezado:</label>
                                            <input type="text" class="form-control" name="experiences[{{$index}}][subheader]"  value="{{$experience->subheader}}" placeholder="empresa" readonly>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <label for="experiences[{{$index}}][from]">Fecha de Inicio:</label>
                                            <input type="date" class="form-control" name="experiences[{{$index}}][from]"  value="{{$experience->from}}" readonly>
                                        </div>
                                        <div class="col-6">
                                            <label for="experiences[{{$index}}][to]">Fecha de Fin:</label>
                                            <input type="date" class="form-control" name="experiences[{{$index}}][to]" value="{{$experience->to}}" readonly>
                                        </div>
                                    </div>
                                    <div class="row mt-1">
                                        <div class="col-6">
                                            <label for="experiences[{{$index}}][is_active]">Actualmente trabajas aca?</label>
                                            <input type="checkbox" class="form-check-input" name="experiences[{{$index}}][is_active]" {{$experience->is_active ? 'checked' : ''}} readonly>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                ...
                <div class="form-group mt-4">
                    ...
                    <div id="awards-container" class="my-2">
                        @if($specialist->awards)
                            @foreach(json_decode($specialist->awards) as $index => $award)
                                <div class="row my-3">
                                    <div class="row">
                                        <h4>Premio o Reconocimiento N°:{{$index}}</h4>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <label for="awards[{{$index}}][header]">Encabezado:</label>
                                            <input type="text" class="form-control" name="awards[{{$index}}][header]" value="{{award->header}}" placeholder="premio" readonly>
                                        </div>
                                        <div class="col-6">
                                            <label for="awards[{{$index}}][subheader]">Sub-Encabezado:</label>
                                            <input type="text" class="form-control" name="awards[{{$index}}][subheader]" value="{{award->subheader}}" placeholder="organización" readonly>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <label for="awards[{{$index}}][date]">Fecha:</label>
                                            <input type="date" class="form-control" name="awards[{{$index}}][date]" value="{{ award->date }}" readonly>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
