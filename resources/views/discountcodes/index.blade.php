    ...
    <div class="table-responsive">
        ...
        <nav aria-label="Page navigation example" class="mt-4">
            <ul class="pagination gap-2">
                <li class="btn btn-dark btn-sm rounded"><a class="text-white no-underline px-2" href="{{ route('discountcodes.index', ['page' => ($discountcodes->currentPage()-1)]) }}">Anterior</a></li>
                ...
                @endfor
                <li class="btn btn-dark btn-sm rounded"><a class="text-white no-underline px-2" href="{{ route('discountcodes.index', ['page' => ($discountcodes->currentPage()+1)]) }}">Siguiente</a></li>
            </ul>
        </nav>
    </div>
    </div>
