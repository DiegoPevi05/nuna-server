...
@section('content')
    ...
    <form method="POST" action="{{ route('discountcodes.store') }}" class="col-6">
        @csrf
        @method('POST')
        ...
        <div class="form-group my-2">
            ...
            <input type="number" step="0.1" min="1" class="form-control @error('discount') is-invalid @enderror" id="discount" name="discount" value="{{ old('discount') }}">
            @error('discount')
            <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        <div class="form-group my-2">
            ...
            <input type="number"  min="1" class="form-control @error('quantity_discounts') is-invalid @enderror" id="quantity_discounts" name="quantity_discounts" value="{{ old('quantity_discounts') }}">
        ...
        <div class="d-flex justify-content-start my-4">
            <button type="submit" class="btn btn-dark w-auto">Crear Codigo de Descuento</button>
        </div>
